#! (ink pub (T i) (attr (type Topic)) (edge (supset [[IANDTA|λ:/Thought-Thing-NL-Cognition/元素/IANDTA]]) (cite [[人和环境是一个不可分割的整体|λ:/Thought-Thing-NL-Cognition/元素/人和环境是一个不可分割的整体]]) (unto [[S = { p_i , i ∈ N+ }|λ:/Thought-Thing-NL-Cognition/元素/S = { p_i , i ∈ N+ }]])))
